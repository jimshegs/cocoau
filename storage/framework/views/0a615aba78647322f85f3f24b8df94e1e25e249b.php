    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type="text" class="form-control" name="title" autofocus
               id="title" value="<?php echo e($title); ?>">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type="text" class="form-control" name="subtitle"
               id="subtitle" value="<?php echo e($subtitle); ?>">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <textarea class="form-control" name="content" rows="14"
                  id="content"><?php echo e($content); ?></textarea>
      </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="form-group">
      ...
      <div class="col-md-8">
        <input class="form-control" name="publish_date" id="publish_date"
               type="text" value="<?php echo e($publish_date); ?>">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-8">
        <input class="form-control" name="publish_time" id="publish_time"
               type="text" value="<?php echo e($publish_time); ?>">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-8">
        <select name="tags[]" id="tags" class="form-control" multiple>
          <?php foreach($allTags as $tag): ?>
            <option <?php if(in_array($tag, $tags)): ?> selected <?php endif; ?>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        <input type="text" class="form-control" name="layout"
               id="layout" value="<?php echo e($layout); ?>">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-8">
        <textarea class="form-control" name="meta_description"
                  id="meta_description"
                  rows="6"><?php echo e($meta_description); ?></textarea>
      </div>
    </div>
