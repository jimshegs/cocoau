<?php $__env->startSection('title', 'Church of Christ | Obafemi Awolowo University'); ?>
            ...
            <div class="container col-md-12">
                    ...
                    <div class="col-md-3" style="margin-left: 5px;">
                        <div class="panel panel-info col-md-12">
                            ...
                            <p><a href="/blog/<?php echo e($post->slug); ?>"><?php echo e($post->title); ?></a></p>
                            <p><?php echo e($post->publish_date); ?> <?php echo e($post->publish_time); ?></p>
                            <?php endforeach; ?>
                        </div>
                    </div>
        	...
        	<div class="row" style="padding-right:55px; padding-left:55px;">
                <?php foreach($uploads as $upload): ?>
    	            <div class="container col-md-3">
    	            	<img class="well" src="<?php echo e(page_image($upload->name)); ?>" style="border-radius: 15px;">
    	            </div>
                <?php endforeach; ?>
            </div>
        </div>
