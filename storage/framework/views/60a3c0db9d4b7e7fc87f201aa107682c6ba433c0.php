      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
          <div class="post-heading">
            <h1 style="color:white"><?php echo e($post->title); ?></h1>
            <h2 class="subheading" style="color:white"><?php echo e($post->subtitle); ?></h2>
            <span class="meta">
...
<?php $__env->startSection('content'); ?>
  ...
  <article>
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1" style="font-size: 18px">
